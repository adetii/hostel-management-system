...
type Props = React.ComponentProps<typeof ContentLoader>;

const DashboardLoader: React.FC<Props> = (props) => (
  <div className="w-full max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
    <ContentLoader
      ...
      // Make it responsive: width 100%, height auto
      width="100%"
      height={undefined}
...
(DashboardLoader as any).metadata = {
